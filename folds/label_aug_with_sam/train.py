...
dataset_train = GenericDataset(split="train", fold_name="folds/fold_3_train.txt", path=DATASET_PATH)
train_loader = DataLoader(dataset_train, batch_size=BATCH_SIZE, unsupervised=True)

dataset_val = GenericDataset(split="val", fold_name="folds/fold_3_val.txt", path=DATASET_PATH)
