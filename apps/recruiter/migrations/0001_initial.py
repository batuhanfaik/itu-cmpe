    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(help_text='Company Name', max_length=8, null=True)),
                ('company_address', models.CharField(help_text='Company Address', max_length=8, null=True)),
