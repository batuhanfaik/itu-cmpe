...
def create_app(db_url):
    ...
    app.add_url_rule("/instructor/<id>/edit", view_func=views.edit_instructor_page, methods=['GET', 'POST'])
    ...
    app.add_url_rule("/course/<crn>/edit", view_func=views.edit_course_page, methods=['POST', 'GET'])
